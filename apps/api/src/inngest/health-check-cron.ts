...
// lib/monitoring/health-checks.ts does not exist yet — defined inline here.
// When that module is created, replace the inline logic with an import.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Alerting utilities
// lib/monitoring/alerting.ts does not exist yet — defined inline here.
// When that module is created, replace the inline logic with an import.
// ---------------------------------------------------------------------------

...
import { getWebVitalRating, WEB_VITALS_THRESHOLDS, reportWebVitalsToSentry } from './web-vitals'
...
describe('reportWebVitalsToSentry', () => {
  ...
  it('reports metric as Sentry measurement', () => {
    ...
    expect(Sentry.setMeasurement).toHaveBeenCalledWith('LCP', 1500, 'millisecond')

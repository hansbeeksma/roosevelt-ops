      ...
      if (summary) {
        setData(
          summary.map((row) => ({
            ...
            avg_work_satisfaction: row.avg_work_satisfaction
              ? parseFloat(row.avg_work_satisfaction)
              : null,
            ...
            avg_review_response_minutes: row.avg_review_response_minutes
              ? parseFloat(row.avg_review_response_minutes)
              : null,
            cross_team_collaboration_pct: row.cross_team_collaboration_pct
              ? parseFloat(row.cross_team_collaboration_pct)
              : null,
            avg_focus_time_minutes: row.avg_focus_time_minutes
              ? parseFloat(row.avg_focus_time_minutes)
              : null,
            avg_meeting_time_minutes: row.avg_meeting_time_minutes
              ? parseFloat(row.avg_meeting_time_minutes)
              : null,
            avg_context_switches: row.avg_context_switches
              ? parseFloat(row.avg_context_switches)
              : null,
          }))
        )
      }
